...
//远程数据
export default class SelectWithDictData extends Component {
  state = {
    value: '',
    mode: 'edit'
  }
  ...
  render () {
    ...
    const props = {
      ...
      field: { dictId: 'CPLM_OBJ_ORG_UNIT' }//字典id需要唯一
    };
    return (
      <div>
        下拉单选，远程数据<strong>(需要配置getData和field.dictId;)</strong>：<FormFieldSelect {...props} /><Button size="small" onClick={this.handleChangeMode} className="margin-left-8" type="primary">切换编辑状态</Button>
      </div>
    );
  }
}